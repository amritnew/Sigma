//
//  PreferredLanguagesCollectionViewCell.swift
//  Sigma
//
//  Created by Alan Victor Paulino de Oliveira on 26/08/19.
//  Copyright © 2019 Vinicius Mangueira. All rights reserved.
//

import UIKit

class PreferredLanguagesCollectionViewCell: UICollectionViewCell {
    let textLabel:UILabel = {
        ...
        label.font = UIFont(font: .boldSystem, size: 16)
